...
Project.create([
  ...
  },
  {
    ...
    description: "A Rails CRUD App in 3 days with 3 other developers. Collaborated to develop requirements and a project roadmap as well as individually contributed Ruby code for models, controllers and routes. ",
  ...
  },
  {
    ...
    description: "Learned Angular and developed an app that CRUDs books on a shared backend API in 3 days.",
  ...
  },
  {
    ...
    description: "Pair programed with another developer to create a travel app that shares experiences and utilizes google maps API.  Collaborated in developing the project roadmap and user experience while adding individual contributions to JavaScript, a MongoDB backend and CSS.
",
